...
redirect_uri = "http://localhost:5173:8000/api/auth/login/google"
...
print("   http://localhost:5173:8000/api/auth/login/google")
print("   http://localhost:5173:8000/auth/login/google")
print("   http://localhost:5173:3000/api/auth/login/google")
print("   http://localhost:5173:3000/auth/login/google")
