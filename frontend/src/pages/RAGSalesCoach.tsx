          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2 text-lg">
                Upload documents to enhance your ForSkale with intelligent knowledge retrieval
              </p>
            </div>
          </div>
        </div>
                    ...
                    <div className="flex-1">
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        ...
                        <li className="flex items-start gap-2">
                          ...
                          <span>Your ForSkale can now access this knowledge for smarter responses</span>
                        </li>
                      </ul>
                    </div>
                  </div>
