...
const STAGE_COLORS: Record<NegotiationStage, string> = {
  Discovery: "bg-[hsl(var(--forskale-teal))]",
  Demo: "bg-[hsl(var(--forskale-blue))]",
  Proposal: "bg-purple-500",
  Negotiation: "bg-orange-500",
  Closing: "bg-[hsl(var(--forskale-green))]",
};
...
function groupByDate(calls: CallItem[]): { date: string; label: string; calls: CallItem[] }[] {
  const today = "Mar 24, 2026";
  const yesterday = "Mar 23, 2026";
      ...
      <div className="relative px-4">
        ...
        >
          ...
          {displayCalls.map((call, idx) => {
            ...
            const evalData = mockCallEvaluations[call.id];
...
const CallListSidebar = ({ calls, selectedId, onSelect, collapsed, onToggle }: CallListSidebarProps) => {
