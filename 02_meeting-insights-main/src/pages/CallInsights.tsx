...
import { Users, GraduationCap, Sparkles, LayoutDashboard } from "lucide-react";
import { cn } from "@/lib/utils";
import { AppLayout } from "@/components/atlas/AppLayout";
import SparkleAttraction from "@/components/call-insights/SparkleAttraction";
              ...
              <div className="flex-1 flex flex-col h-screen overflow-hidden transition-all duration-300 ease-in-out">
                ...
                <div className="flex-1 overflow-y-auto atlas-scrollbar p-8 bg-background transition-all duration-300 ease-in-out">
                  <div className={activeTab === "evaluation" ? "" : "hidden"}>
                    <EvaluationTab onOpenStrategyModal={() => setStrategyModalOpen(true)} />
                  </div>
                  <div className={activeTab === "enablement" ? "" : "hidden"}>
                    <EnablementTab meetingId={selectedCall || "default"} />
                  </div>
                  <div className={activeTab === "summary" ? "" : "hidden"}>
                    <SummaryTab autoAnalyze={true} />
                  </div>
                </div>
              </div>
