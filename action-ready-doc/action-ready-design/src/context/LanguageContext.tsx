...
const translations = {
  ...
  tone: { en: "Tone", it: "Tono" },
  edit: { en: "Edit", it: "Modifica" },
  unsavedChanges: { en: "Unsaved changes", it: "Modifiche non salvate" },
  unsavedChangesMessage: { en: "You have unsaved edits to this draft.", it: "Hai modifiche non salvate in questa bozza." },
  discard: { en: "Discard", it: "Annulla" },
