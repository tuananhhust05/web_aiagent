...
export const mockCustomElements: ExtractedElement[] = [
  {
    id: 'ce1', name: 'Competitive Positioning Framework',
    description: 'Systematic approach to positioning against competitors without direct naming.',
    source: 'challenger-sale', confidence: 87, timestamps: ['02:32', '02:42'],
    transcriptSnippets: ['"Are you currently evaluating other vendors?" (02:32)', '"We had preliminary conversations with two providers." (02:42)'],
    addedToTemplates: false,
  },
  {
    id: 'ce2', name: 'Risk Mitigation Dialogue',
    description: 'Pattern of addressing implementation risks proactively through phased approach.',
    source: 'sandler', confidence: 74, timestamps: ['02:47', '03:04'],
    transcriptSnippets: ['"One concern I have is implementation complexity." (02:47)', '"Would a phased rollout reduce that concern?" (03:04)'],
    addedToTemplates: false,
  },
  {
    id: 'ce3', name: 'Stakeholder Expansion Technique',
    description: 'Identifying additional decision-makers organically through next-step planning.',
    source: 'gap-selling', confidence: 81, timestamps: ['03:19', '03:24'],
    transcriptSnippets: ['"Would it make sense to schedule a more detailed session?" (03:19)', '"I would prefer to bring someone from finance." (03:24)'],
    addedToTemplates: false,
  },
];
...
export const mockCompositePlaybook: CompositeStep[] = [
  { label: 'Opening & Rapport', timeRange: '0:00–0:22', methodology: 'Standard', description: 'Introductory context setting' },
  { label: 'Situation Assessment', timeRange: '0:22–1:02', methodology: 'SPICED', description: 'Current state exploration' },
  { label: 'Pain Discovery', timeRange: '1:02–2:32', methodology: 'SPIN + Custom', description: 'Deep-dive into challenges' },
  { label: 'Budget Qualification', timeRange: '2:32–3:04', methodology: 'BANT', description: 'Vendor landscape and concerns' },
  { label: 'Next Steps & Close', timeRange: '3:04–3:52', methodology: 'MEDDIC', description: 'Follow-up with stakeholder expansion' },
];
