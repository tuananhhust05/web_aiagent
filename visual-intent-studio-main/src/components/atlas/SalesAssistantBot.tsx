      ...
      {view !== "closed" && (
        ...
        >
          ...
          >
            ...
            >
              <h2 className="text-white font-bold text-lg">{t("bot.atlasSalesCoach")}</h2>
            ...
            {(view === "welcome" || view === "meeting-countdown") && (
              <div className="flex flex-col items-center py-10 px-6">
                ...
                <p className="text-base font-semibold text-gray-700 mb-1">
                  {view === "welcome" ? t("bot.turnOnVolume") : t("bot.preparingBrief")}
                </p>
                ...
                <p className="text-sm text-gray-500">
                  {view === "welcome" ? t("bot.startingIn") : t("bot.startingBriefIn")} {countdown} {t("bot.seconds")}
                </p>
              </div>
            )}
            ...
            {view === "meetings" && (
              <div className="py-4 px-6">
                ...
                <h3 className="font-bold text-gray-800 mb-1">{t("bot.yourMeetings")}</h3>
                <p className="text-sm text-gray-500 mb-4">{MOCK_BOT_MEETINGS.length} {t("bot.meetingsCount")}</p>
            ...
            {view === "meeting-brief" && selectedMeeting && (
              <div className="py-4 px-6 max-h-[70vh] overflow-y-auto">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  >
                    <ChevronLeft className="h-4 w-4" /> {t("bot.backToMeetings")}
                  </button>
                  <button
                  ...
                  >
                    <Target className="h-4 w-4" /> {t("bot.planStrategy")}
                  </button>
                </div>
                ...
                <div className="mb-5">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold text-sm text-gray-700">{t("bot.meetingParticipants")}</span>
                  </div>
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold text-sm text-gray-700">{t("bot.companyDescription")}</span>
                  </div>
